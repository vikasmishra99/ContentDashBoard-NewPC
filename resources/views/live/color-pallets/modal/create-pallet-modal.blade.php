<div class="modal modal-blur fade" id="create-new-pallet-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Create Color Pallet for Coloring Book Color Pallet Set</h5>
