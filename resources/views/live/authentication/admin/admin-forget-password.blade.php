    ...
    <div class="container-tight py-4">
        ...
        <form class="card card-md" action="." method="get">
            <div class="card-body">
                ...
                <p class="text-muted mb-4">Enter your email address and a password reset link will be emailed to you.</p>
                <div class="mb-3">
        ...
        <div class="text-center text-muted mt-3">
            Forget it, <a href="{{route('live.authentication.admin.admin-sign-in')}}">send me back</a> to the sign in screen.
        </div>
    </div>
</div>
<!-- Libs JS -->
