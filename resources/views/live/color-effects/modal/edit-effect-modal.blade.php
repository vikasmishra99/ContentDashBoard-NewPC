<div class="modal modal-blur fade" id="edit-effect-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Effect Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- title  -->
                <div class="mb-3">
                    <label class="form-label">Edit Effect Title</label>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="mb-3">
                            <label class="form-label required">Enter Price (INR) for this effect</label>
