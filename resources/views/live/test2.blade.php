                              ...
                              <span class="input-group-text">
                                ...
                                <a href="#" class="link-secondary ms-2 disabled" title="Add notification" data-bs-toggle="tooltip"><!-- Download SVG icon from http://tabler-icons.io/i/bell -->
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{asset('dist/static/coloring-book/categories/new.png')}}" alt="Breakfast served with tea, bread and eggs" class="form-imagecheck-image">
                                  </span>
                                                            </label>
                                                        </div>
                                                        <div class="col-6 col-sm-4">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{asset('dist/static/coloring-book/categories/new.png')}}" alt="Book, fairy lights" class="form-imagecheck-image">
                                  </span>
                                                            </label>
                                                        </div>
                                                        <div class="col-6 col-sm-4">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{asset('dist/static/coloring-book/categories/new.png')}}" alt="Healthy Dinner" class="form-imagecheck-image">
                                  </span>
                                                            </label>
                                                        </div>
                                                        <div class="col-6 col-sm-4">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{asset('dist/static/coloring-book/categories/new.png')}}" alt="Aperol Spritz is a cocktail consisting of prosecco, aperitif and soda water" class="form-imagecheck-image">
                                  </span>
                                                            </label>
                                                        </div>
                                                        <div class="col-6 col-sm-4">
                                  ...
                                  <span class="form-imagecheck-figure">
                                    <img src="{{asset('dist/static/coloring-book/categories/new.png')}}" alt="Beautiful blonde woman on a wooden pier by the lake" class="form-imagecheck-image">
                                  </span>
                                                            </label>
                                                        </div>
                                                        <div class="col-6 col-sm-4">
