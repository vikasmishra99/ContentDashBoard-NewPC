<div class="modal modal-blur fade" id="edit-premium-category-details-modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Premium Category Details</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <!-- title  -->
                <div class="mb-3">
                    <label class="form-label">Edit Premium Category Title</label>
                ...
                <!-- description  -->
                <div class="mb-3">
                    <label class="form-label">Edit Premium Category Description</label>
