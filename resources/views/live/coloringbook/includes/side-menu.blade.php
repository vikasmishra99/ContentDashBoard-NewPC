        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="navbar-nav pt-lg-3">
                    ...
                    <div class="hr-text text-green">Color Pallets Dashboard</div>
                    <li class="nav-item "><a class="nav-link" href="{{route('live.color-pallets.color-pallets-dashboard')}}" ><span class="nav-link-title">Color Pallet Dashboard</span></a></li>
                    <li class="nav-item "><a class="nav-link" href="{{route('live.color-pallets.all-pallets')}}" ><span class="nav-link-title">All Pallets</span></a></li>
                    <li class="nav-item "><a class="nav-link" href="{{route('live.color-pallets.create-pallet')}}" ><span class="nav-link-title">Create Pallets</span></a></li>
                    <div class="hr-text text-green">Effects &amp; Filters</div>
                    <li class="nav-item "><a class="nav-link" href="{{route('live.color-effects.coloring-book-effects')}}" ><span class="nav-link-title">Coloring Book Effects</span></a></li>
                    <li class="nav-item "><a class="nav-link" href="{{route('live.color-filters.coloring-book-filters')}}" ><span class="nav-link-title">Coloring Book Filters</span></a></li>
                    <div class="hr-text text-green">Legals</div>
                    <li class="nav-item"><a class="nav-link" href="{{route('live.pages.changelog')}}" ><span class="nav-link-title">Change Log</span></a></li>
                    <div class="hr-text text-green">Other Actions</div>
                    <li class="nav-item "><a class="nav-link" href="#" ><span class="btn btn-green">CLEAR CACHE</span></a></li>
