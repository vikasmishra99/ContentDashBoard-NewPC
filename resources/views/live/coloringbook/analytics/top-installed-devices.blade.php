...
<head>
    ...
    <title>Top Installed Devices : Coloring Book Dashboard</title>
        ...
        <div class="container-xl">
            ...
            <div class="page-header d-print-none">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <h2 class="page-title">Top Installed Devices</h2>
                        <div class="page-pretitle">Data shows the number of installs based on users devices</div>
                    </div>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Installed Device Distribution</h3>
                            ...
                            <table class="table card-table table-vcenter">
                                ...
                                <tbody>
                                <tr>
                                    <td class="bg-green">SAMSUNG GALAXY A32</td>
