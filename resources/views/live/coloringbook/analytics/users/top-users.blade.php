...
<head>
    ...
    <title>Top Users : Coloring Book Dashboard</title>
        ...
        <div class="container-xl">
            ...
            <div class="page-header d-print-none">
                <div class="row g-2 align-items-center">
                    <div class="col">
                        <h2 class="page-title">Top Users</h2>
                        <div class="page-pretitle">Data shows the top users based on content downloaded</div>
                    </div>
