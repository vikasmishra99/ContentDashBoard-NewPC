        ...
        <div class="row text-center align-items-center flex-row-reverse">
            <div class="col-lg-auto ms-lg-auto">
                <ul class="list-inline list-inline-dots mb-0">
                    ...
                    <li class="list-inline-item"><a href="{{route('live.pages.docs.documentation')}}" class="link-secondary" rel="noopener">Documentation</a></li>
            ...
            <div class="col-12 col-lg-auto mt-3 mt-lg-0">
                <ul class="list-inline list-inline-dots mb-0">
                    <li class="list-inline-item">
                        Copyright &copy; 2022
                        <a href="https://nextleaptechnologies.com/" target="_blank" class="link-secondary">NextLeap Technologies</a>.
                        All rights reserved.
                    </li>
                    <li class="list-inline-item">
